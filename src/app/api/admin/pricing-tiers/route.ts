...
import { listPricingTiers, createPricingTier, updatePricingTier, deletePricingTier, PricingTierRow } from "@/lib/db";
...
export async function PUT(req: NextRequest) {
  try {
    ...
    updatePricingTier(Number(id), updates);
    return Response.json({ success: true });
  } catch (error) {
